...
def reservation_status_changed(sender, instance, **kwargs):
    ...
    if (
        ...
        ReservationHistory.objects.create(
            ...
            establishment=str(instance.id) + ";" + str(instance.establishment),
...
@receiver(post_save, sender=ReservationHistory)
def reservation_deleted(sender, instance, **kwargs):
    """Удаляет бронирование из активных бронирований"""
    reservation_id = instance.establishment.split(";")[0]
    Reservation.objects.get(id=int(reservation_id)).delete()
